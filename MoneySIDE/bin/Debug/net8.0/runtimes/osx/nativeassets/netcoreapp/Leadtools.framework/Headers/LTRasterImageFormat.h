...
typedef NS_ENUM(NSInteger, LTRasterImageFormat) {
    ...
    LTRasterImageFormatOdp                     = 407,
    LTRasterImageFormatOds                     = 408,
    LTRasterImageFormatOdt                     = 409,
    ...
    LTRasterImageFormatAvif                    = 406,
    LTRasterImageFormatHeic                    = 402,
    LTRasterImageFormatWebp                    = 404,
    LTRasterImageFormatWebpAni                 = 405,
};
