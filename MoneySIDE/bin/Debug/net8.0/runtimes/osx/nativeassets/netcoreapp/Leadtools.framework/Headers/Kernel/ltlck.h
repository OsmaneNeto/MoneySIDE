...
// DO NOT FORGET to update the wrappers, for example Xcode LTRasterSupport.h!
...
#if defined(LEADTOOLS_V23_OR_LATER)
      #define L_SUPPORT_PDF_ADVANCED_PSENGINE               5       // Support for advanced PDF features using PS Engine
#else
      #define L_SUPPORT_PDF_ADVANCED                        5        // Support for advanced PDF features.
#endif // #if defined(LEADTOOLS_V23_OR_LATER)
      ...
      #define L_SUPPORT_PDF_ADVANCED_LEADENGINE             43       // Support for advanced PDF features using LEAD Engine
      #define L_SUPPORT_MAX                                 43
